...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout background_universal = (RelativeLayout) findViewById(R.id.background_universal);
        background_universal.setBackgroundResource(R.color.greenlight);
        ...
        dialogfon.setBackgroundResource(R.color.greenforst);
        ...
        while (array.strong[numRight] == array.strong[numLeft]) {
            numRight = random.nextInt(20);
        }
